...
export const metadata = {
  ...
  description: "Senior engineers kill startups by doing exactly what made them senior. $100K in free cloud credits, enterprise experience, \"proper\" architecture — we had it all. We still failed. Not because we built it wrong. We built it well. That was the problem. Here are the mental models that could have saved us.",
  series: { slug: 'founder-mental-models', part: 2 },
  tags: ['Founders', 'Mental Models', 'Engineering'],
};
